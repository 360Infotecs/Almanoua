						...
						<div class="">
								...
								<div class="title_left">
									<h3> <span style='color:red; font-size: 2em;'>
											<?php
												global $con;
												$boom = $_GET['id'];
												$sea_pay = mysqli_query($con, "SELECT * FROM customer WHERE id = '$boom'");
							...
							<input type="hidden" readonly class="form-control has-feedback-left" id="id" name="id" value="<?php echo $x;?>" placeholder="user">
											...
											<div class="col-md-6 col-sm-6 col-xs-12 form-group has-feedback">
													...
													<div class="col-md-6 col-sm-6 col-xs-12 form-group has-feedback">
														<input type="text" class="form-control has-feedback-left" id="Telephone" name="Telephone" value="<?php echo $Telephone;?>">
														<span class="fa fa-phone form-control-feedback left" aria-hidden="true"></span>
													</div>
													
													<div class="col-md-6 col-sm-6 col-xs-12 form-group has-feedback">
														<input type="text" class="form-control" id="CustomerName" name="CustomerName"  value="<?php echo $CustomerName;?>" required>
														<span class="fa fa-user form-control-feedback right" aria-hidden="true"></span>
													</div>
													<div class="col-md-6 col-sm-6 col-xs-12 form-group has-feedback">
														<input type="text" class="form-control has-feedback-left" id="Company" name="Company"  value="<?php echo $Company;?>">
														<span class="fa fa-work form-control-feedback left" aria-hidden="true"></span>
														
													</div>
													<div class="col-md-6 col-sm-6 col-xs-12 form-group has-feedback">
														<input type="text" class="form-control has-feedback-left" id="Address"  name="Address" value="<?php echo $Address;?>">
														<span class="fa fa-phone form-control-feedback left" aria-hidden="true"></span>
													</div>
													<div class="col-md-6 col-sm-6 col-xs-12 form-group has-feedback">
														<input type="email" class="form-control has-feedback-left" id="email" name="email"  value="<?php echo $email;?>">
														<span class="fa fa-email form-control-feedback left" aria-hidden="true"></span>
														
													</div>
													<div class="col-md-6 col-sm-6 col-xs-12 form-group has-feedback">
														<input type="text"  class="form-control has-feedback-left" id="nic" name="nic"  value="<?php echo $nic;?>">
														<span class="fa fa-user form-control-feedback left" aria-hidden="true"></span>
														
													</div>
													<div class="col-md-6 col-sm-6 col-xs-12 form-group has-feedback">
														<input type="text" class="form-control has-feedback-left" id="cusref" name="cusref"  value="<?php echo $cusref;?>">
														<span class="fa fa-email form-control-feedback left" aria-hidden="true"></span>
														
													</div>
													<div class="col-md-6 col-sm-6 col-xs-12 form-group has-feedback">
														<textarea type="text"  class="form-control has-feedback-left" id="remark" name="remark"  value="<?php echo $remark;?>"></textarea>
														<span class="fa fa-user form-control-feedback left" aria-hidden="true"></span>
...
if(isset($_POST['btnsave1'])){ 
	...
	$query = "UPDATE customer SET CusRef='$cusref',CusNo='$Telephone',CusName='$CustomerName',ComName='$Company',Address='$Address',CusEmail='$email',Nic='$nic',CusRemark='$remark',UserEntered='$user',DateandTime ='$date',image='$Image' WHERE id = $boom";

		
		if ($con->query($query) === TRUE) 
		{
			echo"<script>alert('Design insert Successfully')</script>";
			echo"<script>window.open('customerreg.php',target ='_blank')</script>";
		} else 
