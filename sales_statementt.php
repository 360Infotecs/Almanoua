					...
					<div class='col-xs-12'>
						...
						<section class='invoice'>
							...
							<div class="x_title">
								...
								<div align="center">
											<!--<h2>Customer Invoice</h2>-->
											<p><h5><address><h2 ><img class="pull-left" style='height:75px; width:200px;' src='images/invoice.png'><br>Sales Statement</h2><br>
...
<?php
					...
					$sales = 0;
					$stu_query = "SELECT * FROM invoiceorder where Date like '%$todaysDate%' AND BillValue < 1000 ";
