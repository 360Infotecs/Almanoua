              ...
              <div class="col-md-12 col-sm-12 col-xs-12">
                <div class="x_panel">
                  ...
                  <div class="x_content">
					...
					<form class="form-search" method="get" action="salesresult.php" enctype="multipart/form-data">
														<div class="row">
					...
					$sales = 0;
					$stu_query = "SELECT * FROM invoiceorder where Date like '%$search_query%'";
				...
				?>
					  ...
					  <a href="sales_statement.php" ><button class="btn btn-success"><i class="fa fa-print"></i>Print Statement</button></a>
                    </div>
