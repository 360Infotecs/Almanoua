				...
				<div class="main_container">
					...
					<div class="right_col" role="main">
						<div class="">
							...
							<div class="row">
								<div class="col-md-12 col-sm-12 col-xs-12">
									<div class="x_panel">
										<div class="x_title">
											<h2>Add User Informations</h2>
											
											<div class="clearfix"></div>
										</div>
										<div class="x_content">
											<form class="form-horizontal form-label-left input_mask"  method="post" action="user_manage.php" enctype="multipart/form-data">
                        ...
                        <div class="col-md-9 col-sm-9 col-xs-9">
                          <input type="text" id="name_txt_box" class="form-control" name="fullname" requireddata-inputmask="'mask': '99/99/9999'" required>
					  ...
					  <div class="form-group">
                        ...
                        <div class="col-md-9 col-sm-9 col-xs-12">
                          <select type="text" id="name_txt_box" class="form-control" name="designation" placeholder="" required>
						  <option>Admin</option>
						  <option>User</option>
					  ...
					  <div class="form-group">
                        ...
                        <div class="col-md-9 col-sm-9 col-xs-12">
                          <input type="text" id="name_txt_box" class="form-control" name="username" placeholder="" required>
                        </div>
					  </div>
					  <div class="form-group">
                        <label class="control-label col-md-3 col-sm-3 col-xs-12">Password</label>
                        <div class="col-md-9 col-sm-9 col-xs-12">
                          <input type="password" id="pass11"  class="form-control" name="password_1" onkeyup="checkPass1();" placeholder="" required>
                        </div>
                      </div>
					  <div class="form-group">
                        <label class="control-label col-md-3 col-sm-3 col-xs-12">Confirm Password</label>
                        <div class="col-md-9 col-sm-9 col-xs-12">
                          <input type="password" id="pass22" class="form-control" name="password_2" onkeyup="checkPass1();" placeholder="" required>
                        </div>
                      </div>
												...
												<div class="form-group">
												  <label for="" class="col-sm-2 control-label"> Upload Image</label>
													<div class="col-sm-10">
													  <input type="file" id="name_txt_box" name="user_img" id="img"/>
													</div>
												</div>
																...
																<div class="form-group">
																	<div class="pull-right">
																		...
																		<button type="submit" name="create_user" class="btn btn-success" >Save</button>
																		<input type="reset" class="btn btn-danger" value="Reset" onclick="clearall();" style="visibility: visible;">
																	</div>
