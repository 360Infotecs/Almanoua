            ...
            <div class="row">
              <div class="col-md-12 col-sm-12 col-xs-12">
                <div class="x_panel">
				  ...
				  echo"
                    <b> Sales Range of $startdate between $enddate</b>";
					?>
				...
				?>
					  ...
					  <form class="form-search" method="get" action="salesranagestatement.php" enctype="multipart/form-data">
					  
					  
					  <input type="hidden" name="startdate" class="form-control search-query" value="<?php echo $startdate ?>" placeholder="Start Date" />
					  <input type="hidden" name="enddate" class="form-control search-query" value="<?php echo $enddate ?>" placeholder="Start Date" />
					  <a href="salesranagestatement.php" ><button type="submit" class="btn btn-success"><i class="fa fa-print"></i>Print Statement</button></a>
					  </form>
                    </div>
