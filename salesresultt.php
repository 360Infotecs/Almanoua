              ...
              <div class="col-md-12 col-sm-12 col-xs-12">
                <div class="x_panel">
                  ...
                  <div class="x_content">
					...
					<form class="form-search" method="get" action="salesresultt.php" enctype="multipart/form-data">
														<div class="row">
															<div class="col-xs-8 col-sm-6">
																<div class="input-group">
																	...
																	<input type="date" name="user_query" class="form-control search-query" placeholder="Type your Customer Phone number Or Invoice No" />
																	<span class="input-group-btn">
					...
					$sales = 0;
					$stu_query = "SELECT * FROM invoiceorder where Date like '%$search_query%' AND BillValue < 49000  ";
				...
				?>
					...
					<?php echo" <a href='sales_statementt_result.php?id= $search_query '><button class='btn btn-success'><i class='fa fa-print'></i>Print Statement</button></a>";?>
                    </div>
